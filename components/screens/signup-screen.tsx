...
import { useApp, mockUser } from '@/lib/app-context'
      ...
      <div className="flex flex-1 flex-col px-8">
        <div className="mb-10 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <p className="text-muted-foreground">Comece sua jornada de foco</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <button className="text-primary">Termos de Uso</button> e{' '}
            <button className="text-primary">Política de Privacidade</button>.
          </p>

          <Button size="lg" className="mt-4 h-14 text-base" onClick={handleSignup}>
            Criar conta
          </Button>
        </div>
